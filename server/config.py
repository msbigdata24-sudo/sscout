...
BUILD_VERSION = "2026-07-17-history-open-run"
...
FILTER_ALIVE_CONCURRENCY = max(4, min(20, int(os.getenv("FILTER_ALIVE_CONCURRENCY", "16"))))
FILTER_ALIVE_TIMEOUT = max(3, min(15, int(os.getenv("FILTER_ALIVE_TIMEOUT", "6"))))
