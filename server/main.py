...
def health():
    ...
    return {
        ...
        "scraping_configured": bool(ZENROWS_API_KEY or SCRAPINGBEE_API_KEY or SCRAPINGFISH_API_KEY),
        ...
        "proxy_configured": bool(ZENROWS_API_KEY or SCRAPINGBEE_API_KEY or SCRAPINGFISH_API_KEY),
